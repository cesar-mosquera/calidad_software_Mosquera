...
describe('useTodos', () => {
  ...
  it('respeta el estado inicial provisto', () => {
    ...
    const inicial: Todo[] = [{ id: 'a', text: 'Tarea', completed: false, titulo: 'Ciencias Quimicas' }]
    const { result } = renderHook(() => useTodos(inicial))
  ...
  it('remove elimina la tarea por id', () => {
    const inicial: Todo[] = [
      ...
      { id: 'b', text: 'Dos', completed: false, titulo: 'Tares 2' },
      { id: 'c', text: 'Tres', completed: false, titulo: 'Tares 3' },
    ]
    const { result } = renderHook(() => useTodos(inicial))
...
describe('useTodos — filtro', () => {
  function setup() {
    const inicial: Todo[] = [
      { id: '1', text: 'Activa', completed: false, titulo: 'status' },
      { id: '2', text: 'Hecha', completed: true, titulo: 'status' },
    ]
